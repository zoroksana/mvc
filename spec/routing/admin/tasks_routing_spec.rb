...
RSpec.describe Admin::TasksController, type: :routing do
  describe "routing" do
    ...
    it "routes to #new" do
      expect(:get => "/admin/tasks/new").not_to route_to("admin/tasks#new")
    end
    ...
    it "routes to #edit" do
      expect(:get => "/admin/tasks/1/edit").not_to route_to("admin/tasks#edit", :id => "1")
    end

    it "routes to #create" do
      expect(:post => "/admin/tasks").not_to route_to("admin/tasks#create")
    end
    ...
    it "routes to #destroy" do
      expect(:delete => "/admin/tasks/1").not_to route_to("admin/tasks#destroy", :id => "1")
    end
  end
end
